...
void turbo_encoder_impl::generic_work(const void* inbuffer, void* outbuffer)
{
    ...
    auto enco_n = aff3ct::module::Encoder_RSC_generic_sys<>(K, N, d_buffered, d_polys);
    auto enco_i = aff3ct::module::Encoder_RSC_generic_sys<>(K, N, d_buffered, d_polys);
    aff3ct::tools::Interleaver_core_LTE<> core(N);
