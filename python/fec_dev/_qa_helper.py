...
class _qa_helper(gr.top_block):
    ...
    def __init__(self, data_size, enc, dec, threading):
        ...
        src_data = [0, 1, 2, 3, 5, 7, 9, 13, 15, 25, 31, 45, 63, 95, 127]
        rep_size = data_size // len(src_data)
        src_data_rep = ((rep_size + 1) * src_data)[:data_size]
        ...
        self.src = blocks.vector_source_b(src_data_rep, False)
